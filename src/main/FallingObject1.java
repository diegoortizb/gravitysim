...
public class FallingObject1 extends FallingObject {
	...
	public FallingObject1(float x, float y, ID id, Handler handler) {
		super(x, y, id);
	...
	public void render(Graphics g) {
		 ...
		 g.fillRect((int)x, (int)y, 17, 17);
		 g.setColor(Color.black);
		 g.fillRect((int)x+1, (int)y+1, 15, 15);
	}
}
